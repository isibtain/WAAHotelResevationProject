...
//          .authoritiesByUsernameQuery( "select u1.username, u2.authority from user u1, authorities u2 where u1.username = u2.username and u1.username =?" );
    }
